...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Saya hanya bot jika ada masalah silahkan pc owner saya : line://ti/p/~babydino20",
    "lang":"JP",
    "comment":"Saya hanya bot jika ada masalah silahkan pc owner saya : line://ti/p/~babydino20",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					if msg.toType == 2:
						...
						cl.sendText(msg.to,"Kami diperintah untuk menghancurkan grub ini´")
						ki.sendText(msg.to,"Penghancuran akan berlangsung.")
            kk.sendText(msg.to,"Penghancuran akan berlangsung.")
						targets = []
						for g in gs.members:
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"Inori hadir")
          ki.sendText(msg.to,"Miku hadir")
          kk.sendText(msg.to,"Hanami hadir")
#-----------------------------------------------
            elif "Bot say " in msg.text:
					bctxt = msg.text.replace("hay kami disini ","")
...
#-----------------------------------------------
            	...
            	if msg.from_ in admin:
            		...
            		if cmd == "on":
            			...
            			target0 = msg.text.replace("Target","")
...
#-----------------------------------------------
                ...
                if msg.from_ in creator:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                admin.append(target)
                                cl.sendText(msg.to,"Cie dikit lagi jadi admin")
                                ki.sendText(msg.to,"1,2,3")
                                kk.sendText(msg.to,"Selamat kamu jadi admin")
                            except:
                                pass
                ...
                if msg.from_ in creator:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                kk.sendText(msg.to,"nanti kita ketwa wkwk")
                            except:
                                pass
                    ...
                    kk.sendText(msg.to,"jadi jangan sok")
...
#-----------------------------------------------
            ...
            elif msg.text in ["Bot hay"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Hay kamu¿")
					kk.sendText(msg.to,"Kenapa manggil")
					kc.sendText(msg.to,"Mau di manja?")
            elif msg.text in ["#welcome"]:
				if msg.from_ in admin:
					cl.sendText(msg.to,"Hay selamat datang")
					ki.sendText(msg.to,"Patuhi rules")
          kk.sendText(msg.to,"kalau tidak kamu aku kick")
#-----------------------------------------------
            elif msg.text in ["PING","Ping","ping","Samlekom","samlekom"]:
				cl.sendText(msg.to,"Muka kamu imut")
				ki.sendText(msg.to,"Tapi sayang hatimu busuk")
				kk.sendText(msg.to,"kaya apinka")
#-----------------------------------------------
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					start = time.time()
					cl.sendText(msg.to, "ngitung dulu...")
