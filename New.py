...
creator=["uddb6b470ab4b54c5fbc69d7600cc3bc811"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
            elif "Mimic say " in msg.text:
					bctxt = msg.text.replace("malik say ","")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"owner line:://ti/p/~babydino20 ")
						print "DiLike"
					except:
							pass
				else:
