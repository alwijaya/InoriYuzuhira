...
Bots=[mid,Amid,Bmid]
admin=["uddb6b470ab4b54c5fbc69d7600cc3bc8","u0c54fb3fc0113d7cd7b73cccea0cd5e4","uf4a837a5f4e413ac811d790f8f578bc9","u110b2229999631aa6284f70e9d2c7c92"]
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"MyGithub : github.com/AlferdWijaya")
						print "DiLike"
					except:
							pass
				else:
