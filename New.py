...
creator=["uddb6b470ab4b54c5fbc69d7600cc3bc8","u0c54fb3fc0113d7cd7b73cccea0cd5e4","uf4a837a5f4e413ac811d790f8f578bc9","u110b2229999631aa6284f70e9d2c7c92"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
                            ...
                            kc.sendText(msg.to,"Origami Respon")
				...
				if msg.from_ in admin:
					if msg.toType == 2:
						...
						if matched_list == []:
							...
							kc.sendText(msg.to,"kamu pantas diusir")
							return
