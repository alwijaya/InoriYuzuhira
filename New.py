...
=========================
BOT : Alferd
KARAKTER : DATE A LIVE WIKI
SUPPORT BY : L̵̛̦̝̟̼͙̬̦̝̯͒͒̊͠I̶̎̎͋̑͂̽ͥ̚҉̼̮͍͇̣̦̪͎͓Ņ̴̠̖̹͙̗͕́̏̉̔̾͋ͧ̑Ḙ̛̦̭̰̘̳̼̪̒͛̃͊̒ͮ̋́̚͡ͅ ̶̣̙͈̳͍͂̀̽̾̇̓̐ͅD͈͎͇̠̪͍͇͉̀̈͌E̵͊̀҉͔͖̭͉̘͇V͈̖̪͈̓̓ͦ̂̓̍͒̐ͅͅE̝̲͋ͨL̛̯͎̝̈̌̃́Ŏ̵͌̔ͤ͊͏̙͙ͅP̴͎͙͔̠̖̫ͬ͑͑̅̆̉̕E̸̴̠͛͂ͨR͈̫͎͒ͮ͒ͯ̀ ̶̢̯̝͕̫̮̺͊̉̿̿̽̈̅͐ͅB̙͉͉̼̫̗̟̯̽̍ͪ̋͆͂͂͘͡Ö̸̧͍̬̟͙́̅͆̎̃̕T̶̯͔̦̟̠̊̀̄̐̇́̄͂ͭ͜S̵̡͈̝̭͈̪ͮ̈̓̍̀E
"""
KAC=[cl,ki,kk]
...
Bots=[mid,Amid,Bmid]
admin=["uddb6b470ab4b54c5fbc69d7600cc3bc8","u110b2229999631aa6284f70e9d2c7c92","u0c54fb3fc0113d7cd7b73cccea0cd5e4"]
creator=["uddb6b470ab4b54c5fbc69d7600cc3bc8","u0c54fb3fc0113d7cd7b73cccea0cd5e4"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Thanks sudah add, jika ada masalah dengan bot hubungi Owner kami di: line://ti/p/~babydino11",
    "lang":"JP",
    "comment":"Thanks sudah add, jika ada masalah dengan bot hubungi Owner kami di: line://ti/p/~babydino11",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
							...
							cl.sendText(msg.to,"Tohka datang")
							ki.sendText(msg.to,"Miku datang")
							kk.sendText(msg.to,"Kurumi datang")
							cl.sendText(msg.to,"Kami siap melindungi atau menghancurkan grub ini,sesuai printah Boss")
#-----------------------------------------------
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"Tohka Yatogami")
					ki.sendText(msg.to,"Miku Izayoi")
					kk.sendText(msg.to,"Kurumi Tokisaki")
#-----------------------------------------------
...
#-----------------------------------------------
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "== DAFTAR SIDER == %s\nthat's it\n\nDAFTAR MEREKA YANG SIDER DAN TIDAK MUNCUL DI GRUP\n%smalu maluin, minta join nangis nangis taunya cumn jdi sider pas masuk. 7¬8\n\nReading point creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
...
#-----------------------------------------------
                ...
                jawab = ("Ya","Tidak","Mungkin","Bisa jadi","Bohong","Mustalih","Tidak mungkin","coba lagi",)
...
#-----------------------------------------------
              ...
              if msg.from_ in creator:
                if admin == []:
                    ...
                    kk.sendText(msg.to,"Sabar ya sabar")
                    mc = ""
                    for mi_d in admin:
                        mc += "=>" +cl.getContact(mi_d).displayName + "\n"
                    cl.sendText(msg.to,mc)
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                 if wait["Protectcancel"] == True:
                     if wait["lang"] == "JP":
                         cl.sendText(msg.to,"Ku peringatkan jangan main main disini!")
...
#-----------------------------------------------
            ...
            elif msg.text in ["Alfed gimana orangnya"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Dia baik,ramah banget orangnya")
					kk.sendText(msg.to,"Cogan cina,keren dek pokoknya")
					kc.sendText(msg.to,"Gk akan nyesel jadi pacarnya")
...
#-----------------------------------------------
				...
				ki.sendText(msg.to,"Muka kamu imut")
				kk.sendText(msg.to,"Tapi sayangnya")
				kc.sendText(msg.to,"Hati kamu busuk")
#-----------------------------------------------
            elif msg.text in ["Responsename","Respon"]:
				if msg.from_ in admin:
					cl.sendText(msg.to,"Tohka Respon")
					ki.sendText(msg.to,"Miku Respon")
					kk.sendText(msg.to,"Kurumi Respon")
#-----------------------------------------------
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line://ti/p/~babydino11")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Udah di like ya")
						print "DiLike"
					except:
							pass
				else:
