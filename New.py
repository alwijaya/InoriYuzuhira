    ...
    try:
        ...
        if op.type == 15:
            if op.param2 in Bots:
                return
            ki.sendText(op.param1, "Semoga tenang disana ya")
            print "MemberLeft"
        if op.type == 13:
            if op.param3 in mid:
              ...
              if msg.from_ in admin:
				...
				if msg.from_ in admin:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "List orang yang muncul di grub %s\nthat's it\n\nDibawah ini daftar orang yang doyannya sider doang\n%sMalu maluin,Minta join nangis nangis taunya cuman nyider 7¬8\n\nReading point creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
				...
				if msg.from_ in admin:
					if msg.toType == 2:
						...
						if matched_list == []:
							...
							kc.sendText(msg.to,"Sampah emang pantes dibuang")
							return
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"Miku Boss")
					ki.sendText(msg.to,"Tohka Boss")
#-----------------------------------------------
            elif "Miku say " in msg.text:
					bctxt = msg.text.replace("Tob say ","Tohka say")
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                 if wait["Protectcancel"] == True:
                     if wait["lang"] == "JP":
                         cl.sendText(msg.to,"Jangan macam macam di grub ini kalau tidak ingin aku marah!")
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Imut")
					kk.sendText(msg.to,"Baik")
					kc.sendText(msg.to,"Ganteng dan segalanya")
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					...
					ki.sendText(msg.to,"7Pd64TIBouM4OHYTG Respon")
#-----------------------------------------------
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Trcyduck oleh @babydino")
						print "DiLike"
					except:
							pass
				else:
