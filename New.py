...
helpMessage ="""C̃ỸB̃ẼR̃ B̃ÕT̃ S̃C̃R̃ĨM̃Ẽ ν2.9
닾탈 페린탛
┏━━━━━━━━━━━━━━━
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"B⃖O⃖T⃖ P⃖R⃖O⃖T⃖E⃖C⃖T⃖ O⃖N⃖")
					ki.sendText(msg.to,"B⃖O⃖T⃖ P⃖R⃖O⃖T⃖E⃖C⃖T⃖ O⃖N⃖")
					kk.sendText(msg.to,"B⃖O⃖T⃖ P⃖R⃖O⃖T⃖E⃖C⃖T⃖ O⃖N⃖")
					ky.sendText(msg.to,"B⃖O⃖T⃖ P⃖R⃖O⃖T⃖E⃖C⃖T⃖ O⃖N⃖")
					kl.sendText(msg.to,"B⃖O⃖T⃖ P⃖R⃖O⃖T⃖E⃖C⃖T⃖ O⃖N⃖")
#-----------------------------------------------------------
...
#-------------------------------------------------------------
		  ...
		  if msg.from_ in admin:
		    if msg.toType == 2:
			    ...
			    pass
#-------------------------------------------------------------
            elif "@Pancy" in msg.text:
                tanya = msg.text.replace("@Pancy","")
