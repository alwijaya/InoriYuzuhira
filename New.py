...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"Miku hadir Boss")
					ki.sendText(msg.to,"Tohka juga hadir Boss")
#-----------------------------------------------
...
#-----------------------------------------------
            ...
            elif msg.text in ["gua gimana"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Manis")
					kk.sendText(msg.to,"ganteng")
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"Miku disini")
					ki.sendText(msg.to,"Tohka disini")
#-----------------------------------------------
